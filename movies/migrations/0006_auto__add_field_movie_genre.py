...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'movies_movie', 'genre',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'movies_movie', 'genre')


    models = {
        u'movies.award': {
            'Meta': {'object_name': 'Award'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'awards'", 'null': 'True', 'to': u"orm['movies.Show']"}),
