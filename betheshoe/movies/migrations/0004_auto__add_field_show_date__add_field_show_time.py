...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.date'
        db.add_column(u'movies_show', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Show.time'
        db.add_column(u'movies_show', 'time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.date'
        db.delete_column(u'movies_show', 'date')

        # Deleting field 'Show.time'
        db.delete_column(u'movies_show', 'time')
